...
#' Plot the fequency of one word against another word over time in a JSTOR DfR dataset
#' 
#' @description Function to plot changes in the relative frequency of two words over time. The relative frequency is the frequency of the word in a document divided by the total number of words in a document. For use with JSTOR's Data for Research datasets (http://dfr.jstor.org/).
...
#' @examples 
#' JSTOR_1word("diamonds", "pearls")
#' JSTOR_1word("milk", "sugar")
...
JSTOR_2words <- function(word1, word2){
  ...
  # calculate ratios
  word1_ratio <- word1/the
  word2_ratio <- word2/the
