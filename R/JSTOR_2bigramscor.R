...
JSTOR_2bigramscor <- function(x, bigram1, bigram2, span = 0.4){
  ...
  c2bigrams_by_year <- data.frame(cbg1 = cbg1_ratio, cbg2 = cbg2_ratio, year = as.numeric(as.character(bibliodata$year)))
